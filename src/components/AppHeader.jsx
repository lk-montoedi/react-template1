                            ...
                            dark:shadow-none dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <div className="text-gray-600 dark:text-gray-300 lg:pr-4 lg:w-auto w-full lg:pt-0">
                                        <ul className="tracking-wide font-medium lg:text-sm flex-col flex lg:flex-row gap-6 lg:gap-0">
                                            <li>
                                                <Link to="/#features" className="block md:px-4 transition hover:text-primary">
                                                    <span>Features</span>
                                                </Link>
                                            </li>
                                            <li>
                                                <Link to="/#solution" className="block md:px-4 transition hover:text-primary">
                                                    <span>Solution</span>
                                                </Link>
                                            </li>
                                            <li>
                                                <Link to="/#testimonials" className="block md:px-4 transition hover:text-primary">
                                                    <span>Testimonials</span>
                                                </Link>
                                            </li>
                                            <li>
                                                <Link to="/#blog" className="block md:px-4 transition hover:text-primary">
                                                    <span>Blog</span>
                                                </Link>
                                            </li>
                                        </ul>
